...
@implementation MDStopsTableView
...
- (void)viewDidLoad{
    [super viewDidLoad];
    self.stops = [[OCTADatabase database] stops:routeForStop.route_id];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Routes *route = [self.stops objectAtIndex: indexPath.row];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    if ([segue.identifier isEqualToString:@"detailsegue"]){
        ...
        MDDetailViewController* detailVC = segue.destinationViewController;
